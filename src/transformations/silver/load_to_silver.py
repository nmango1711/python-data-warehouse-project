...
def load_to_silver(spark):
    ...
    transform_to_silver_cust_az12(BRONZE_PATH, SILVER_PATH, spark)
    transform_to_silver_loc_a101(BRONZE_PATH, SILVER_PATH, spark)
    transform_to_silver_px_cat_g1v2(BRONZE_PATH, SILVER_PATH, spark)